...
<head>
  ...
  <style>
    ...
    body {
      background-image: url('https://tinyurl.com/27vnaujs');
  ...
  <footer class="footer">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu" aria-labelledby="contactDropdown">
        <li><a class="dropdown-item" href="https://www.facebook.com/Krish021">Facebook</a></li>
        <li><a class="dropdown-item" href="https://www.instagram.com/_datboii.krish?igsh=MTN0N2Y5cDNqN2lvbw==">Instagram</a></li>
      </ul>
    </div>
  </footer>
